 ...
 * ---------------------
 * Description: Defect code used to identify instances of return value of function call never checked
 *
 ***********************************************************************/
...
/***********************************************************************
 *
 * Defect type: Function call return value never checked for validity 
 * Complexity: Value returned to the calling function is assigned but never used  
 *
 ***********************************************************************/
...
void function_return_value_unchecked_001 ()
{
	...
	a = function_return_value_unchecked_001_func_002(1); /* ERROR: Return value of function never checked */
}

/***********************************************************************
 *
 * Defect type: Function call return value never checked for validity 
 * Complexity: Value returned to the calling function is never assigned 
 *
 ***********************************************************************/
...
void function_return_value_unchecked_002 ()
{
	...
	function_return_value_unchecked_002_func_001(10); /* ERROR: Return value of function never checked */
    	if (a >0)
    	{
		a--;
	}
...
{
	int a=1;
	char buf = function_return_value_unchecked_003_func_001(); /* ERROR: Return value of function never checked */
...
void function_return_value_unchecked_004 ()
{
	...
	s= function_return_value_unchecked_004_s_001_func_001(); /* ERROR: Return value of function never checked */
	switch (flag)
	{
		case 1:
		{
...
typedef struct {
	...
	char *a;
	int b;
} function_return_value_unchecked_structure;

function_return_value_unchecked_structure   function_return_value_unchecked_structure_func_001 ()
{
	function_return_value_unchecked_structure u1;
	char *s = "This is STR";
...
{
	function_return_value_unchecked_structure u ;
	int i;
	
	for(i=0;i<10;i++)
	{
		u = function_return_value_unchecked_structure_func_001(); /* ERROR: Return value of function never checked */
        	if (i==5)
		{
       			if(u.b >0)
			{
...
void function_return_value_unchecked_006 ()
{
	...
	while (i>0)
	{
		ptr = function_return_value_unchecked_006_func_001(); /* ERROR: Return value of function never checked */
		for(;(j!=0 && j<4);j++)
		{
	 		if(*(ptr[j]) >0)
	        	{
...
{
	int i = function_return_value_unchecked_007_func_001(); /* ERROR: Return value of function never checked */
...
{
	int i = function_return_value_unchecked_008_func_001(6.00); /* ERROR: Return value of function never checked */
...
void function_return_value_unchecked_009 ()
{
	...
	if(a == 20)
    	...
    	{
    		function_return_value_unchecked_009_func_001( arr, (sizeof (arr)/sizeof (double)) ); /* ERROR: Return value of function never checked */
		c ++;
  	}
}
...
void function_return_value_unchecked_010 ()
{
	...
	if (function_return_value_unchecked_010_var == MAX)
    	{
        	fprintf(stdout, "%s\n", "TEST STRING"); /* ERROR: Return value of function never checked */
            	a++;
        }
	else
        {
...
void function_return_value_unchecked_011 ()
{
    	...
    	for(k = 0;k < 5;k++)
    	{
    		char buf[100] = "";
        	char * buf1 = buf;
        	snprintf(buf1,100-strlen(STR)-1, "%s\n", STR); /* ERROR: Return value of function never checked */
    	}
}
...
void function_return_value_unchecked_012 ()
{
    	while(1)
    	{
        	fputc((int)'A', stdout); /* ERROR: Return value of function never checked */
         	break;
    	}
}
...
void function_return_value_unchecked_013 ()
{
    	...
    	{
        	fputs("STRING#", stdout); /* ERROR: Return value of function never checked */
    	}
}
...
void function_return_value_unchecked_014 ()
{
	...
	goto label;
label:
    	putchar((int)'A'); /* ERROR: Return value of function never checked */
    	a++;
}
...
void function_return_value_unchecked_015 ()
{
	...
	switch(flag)
    	{
    		case 6:
        		puts("TEST"); /* ERROR: Return value of function never checked */
        		i=20;
       	 		break;
   	 	default:
        		i=10;
 ...
 *
 ***********************************************************************/
function_return_value_unchecked_structure function_return_value_unchecked_016_s_001_func_001 ()
{
	function_return_value_unchecked_structure u1;
	char *s ="This is STR";
